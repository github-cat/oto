package com.changhong.oto.common.utils.file;
...
import com.changhong.oto.common.utils.crypt.BASE64Coder;
...
public class FileUploader {
	...
	public void uploadBase64(String fieldName) {
		...
		try {
			...
			byte[] b = BASE64Coder.decodeb(base64Data);
	...
	private void parseParams() {
		...
		try {
			...
			sfu.setHeaderEncoding(FileUploader.ENCODEING);
