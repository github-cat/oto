 ...
 ***********************************************************************
 */
package com.changhong.oto.common.utils.resolver;
...
import com.changhong.oto.common.utils.O2oExcpetion;
import com.changhong.oto.common.utils.crypt.MainApiUtils;
...
public class GlobalExceptionResolver extends SimpleMappingExceptionResolver {
	...
	public ModelAndView resolveException(HttpServletRequest request,
		...
		if(ex instanceof O2oExcpetion){
			...
			rs.setData(o2oEx.getData());
			rs.setErrorCode(o2oEx.getErrorCode());
			rs.setMsg(o2oEx.getMessage());
		}else{
			rs.setErrorCode(1001);
			rs.setMsg("系统错误");
		}
	...
	private boolean isJsonCrypt(HttpServletRequest request){
		if(request.getHeader("Content-Type").contains("application/crypt-json")) return true;
		return false;
	}
	...
	private boolean isFromApp(HttpServletRequest request){
		if(StringUtils.isNotBlank(request.getHeader(appTag))) return true;
		return false;
	}
